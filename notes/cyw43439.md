...
CYW43439 using SPI, SDIO to forward and receive frames. Also control requests
...
* Function 1, backplane function access
...
### Backplane
This is part of the WLAN component and is a like a connection bus to all the
other components of this component, like 

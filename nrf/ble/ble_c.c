...
/* Scanning LED will be on when the device is scanning. */
#define CENTRAL_SCANNING_LED            BSP_BOARD_LED_0

/* Connected LED will be on when the device is connected. */
#define CENTRAL_CONNECTED_LED           BSP_BOARD_LED_1

/* LED to indicate a change of state of the the Button characteristic on the peer. */
...
/* Application's BLE observer priority. Used for handlers that handle the same
 * type of events to be able to specify which handler should process the event
 * first.
 */
...
/* Main structure used by the LBS client module. */
